...
entity deal_img_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 8; 
            AWIDTH     : integer := 22; 
            MEM_SIZE    : integer := 2764800
    ); 
    port (
...
architecture rtl of deal_img_ram is 
...
architecture arch of deal_img is
    component deal_img_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    deal_img_ram_U :  component deal_img_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
