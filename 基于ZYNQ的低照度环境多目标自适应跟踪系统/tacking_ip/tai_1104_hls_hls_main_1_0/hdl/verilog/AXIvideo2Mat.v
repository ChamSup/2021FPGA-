...
wire   [0:0] brmerge_fu_322_p2;
wire    ap_CS_fsm_state8;
wire   [0:0] ap_phi_mux_eol_2_phi_fu_271_p4;
...
reg   [31:0] t_V_2_reg_196;
reg   [0:0] eol_reg_207;
reg   [0:0] axi_last_V_2_reg_219;
reg   [23:0] p_Val2_s_reg_232;
reg    ap_block_state1;
reg   [23:0] tmp_data_V_reg_367;
reg   [0:0] tmp_last_V_reg_375;
wire   [0:0] exitcond2_fu_297_p2;
wire    ap_CS_fsm_state4;
wire   [31:0] i_V_fu_302_p2;
reg   [31:0] i_V_reg_391;
reg    ap_predicate_op52_read_state5;
reg    ap_block_state5_pp1_stage0_iter0;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [31:0] j_V_fu_313_p2;
wire   [7:0] tmp_177_fu_328_p1;
reg   [7:0] tmp_177_reg_409;
reg   [7:0] tmp_9_reg_414;
reg   [7:0] tmp_10_reg_419;
reg    ap_block_state8;
...
reg   [23:0] axi_data_V_3_reg_256;
reg   [23:0] axi_data_V1_reg_153;
reg   [31:0] t_V_reg_163;
reg   [0:0] ap_phi_mux_eol_1_phi_fu_177_p4;
reg   [23:0] ap_phi_mux_axi_data_V_1_phi_fu_188_p4;
reg   [0:0] ap_phi_mux_eol_phi_fu_211_p4;
wire   [0:0] ap_phi_reg_pp1_iter0_axi_last_V_2_reg_219;
reg   [23:0] ap_phi_mux_p_Val2_s_phi_fu_236_p4;
wire   [23:0] ap_phi_reg_pp1_iter0_p_Val2_s_reg_232;
wire    ap_CS_fsm_state7;
reg   [0:0] eol_2_reg_268;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond2_fu_297_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond2_fu_297_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_reg_396 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((eol_2_reg_268 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_reg_268 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_556)) begin
        if (((brmerge_fu_322_p2 == 1'd1) & (exitcond_fu_308_p2 == 1'd0))) begin
            axi_last_V_2_reg_219 <= ap_phi_mux_eol_1_phi_fu_177_p4;
        end else if (((brmerge_fu_322_p2 == 1'd0) & (exitcond_fu_308_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_fu_308_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_fu_88 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_fu_308_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_10_reg_419 <= {{ap_phi_mux_p_Val2_s_phi_fu_236_p4[23:16]}};
        tmp_177_reg_409 <= tmp_177_fu_328_p1;
        tmp_9_reg_414 <= {{ap_phi_mux_p_Val2_s_phi_fu_236_p4[15:8]}};
    end
end
...
always @ (*) begin
    if (((~((eol_2_reg_268 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_reg_268 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_predicate_op52_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((exitcond2_fu_297_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((exitcond_reg_396 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_634)) begin
        if ((brmerge_fu_322_p2 == 1'd1)) begin
            ap_phi_mux_p_Val2_s_phi_fu_236_p4 = ap_phi_mux_axi_data_V_1_phi_fu_188_p4;
        end else if ((brmerge_fu_322_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_reg_268 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((brmerge_fu_322_p2 == 1'd0) & (exitcond_fu_308_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond_fu_308_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond_fu_308_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((eol_2_reg_268 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_reg_268 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((eol_2_reg_268 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (ap_phi_mux_eol_2_phi_fu_271_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_reg_396 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_396 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_396 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)))) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op52_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_reg_396 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_396 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_396 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)))) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op52_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_reg_396 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_396 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_396 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)))) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op52_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((exitcond_reg_396 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_396 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_396 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state8 = ((eol_2_reg_268 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end
...
always @ (*) begin
    ap_condition_634 = ((exitcond_fu_308_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end

assign ap_enable_pp1 = (ap_idle_pp1 ^ 1'b1);

assign ap_phi_mux_eol_2_phi_fu_271_p4 = eol_2_reg_268;

assign ap_phi_reg_pp1_iter0_axi_last_V_2_reg_219 = 'bx;

assign ap_phi_reg_pp1_iter0_p_Val2_s_reg_232 = 'bx;

always @ (*) begin
    ap_predicate_op52_read_state5 = ((brmerge_fu_322_p2 == 1'd0) & (exitcond_fu_308_p2 == 1'd0));
end

assign brmerge_fu_322_p2 = (sof_1_fu_88 | ap_phi_mux_eol_phi_fu_211_p4);

assign exitcond2_fu_297_p2 = ((t_V_reg_163 == img_rows_V_read) ? 1'b1 : 1'b0);

assign exitcond_fu_308_p2 = ((t_V_2_reg_196 == img_cols_V_read) ? 1'b1 : 1'b0);

assign i_V_fu_302_p2 = (t_V_reg_163 + 32'd1);

assign img_data_stream_0_V_din = tmp_177_reg_409;

assign img_data_stream_1_V_din = tmp_9_reg_414;

assign img_data_stream_2_V_din = tmp_10_reg_419;

assign input_r_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign j_V_fu_313_p2 = (t_V_2_reg_196 + 32'd1);

assign tmp_177_fu_328_p1 = ap_phi_mux_p_Val2_s_phi_fu_236_p4[7:0];
